 ...
 * @LastEditTime: 2020-09-25 21:01:21
 */
// 高阶函数 2个特点满足一个就是高阶函数 
// 1）我们给一个函数传入一个函数
// 2) 一个函数返回一个函数
...
Function.prototype.before = function(beforeFn) {
    ...
    return (...args) => { // 不能是普通函数 this会指向调用者环境 箭头函数中没有this 没有arguments 没有prototype  这些属性都会向上查找
        console.log(args);
        console.log(...args);
        beforeFn();
        // ...解构运算符 把数组解构为一个个参数
...
Function.prototype.after = function(afterFn) {
    // this 指向 core
    console.log(this);
    return () => { // 不能是普通函数 this会指向调用者环境 箭头函数中没有this 没有arguments 没有prototype  这些属性都会向上查找
        afterFn();
        this(); // 指向core()
    }
}
